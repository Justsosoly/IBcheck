...
package com.ib.dailycheck;
import java.text.SimpleDateFormat;
import java.util.*;

import com.ib.client.*;
import com.ib.advisor.FAMethodSamples;
import com.ib.contracts.ContractSamples;
import com.ib.orders.AvailableAlgoParams;
import com.ib.orders.OrderSamples;
import com.ib.scanner.ScannerSubscriptionSamples;
...
//		orderOperations(wrapper.getClient(), wrapper.getCurrentOrderId());
	...
	private static void accountOperations(EClientSocket client) throws InterruptedException {
		...
		//! [reqpositionsmulti]
        //client.reqPositionsMulti(9003, "DU74649", "EUstocks");//9003 是个随意的请求ID号？只要不重复即可？
 //   client.reqPositionsMulti(9003, "U9238923", "EUstocks");//注释掉并不影响输出结果
        ...
        //! [reqmanagedaccts]
        client.reqManagedAccts();//输出结果是Account list: U10019359,U9238923，
        //! [reqmanagedaccts]

		/*** Requesting family codes***/
		//! [reqfamilycodes]
		//client.reqFamilyCodes();无家庭账户，所以并没有用
		//! [reqfamilycodes]
